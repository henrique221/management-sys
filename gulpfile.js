...
var srcDir = './node_modules/chart.js/dist';
var outDir = 'public/assets/dist';
...
function buildTask() {
  ...
  var bundled = browserify('./node_modules/chart.js', { standalone: 'Chart' })
    .plugin(collapse)
    .bundle()
  ...
  var nonBundled = browserify('./node_modules/chart.js', { standalone: 'Chart' })
    .ignore('moment')
    .plugin(collapse)
    .bundle()
    .on('error', errorHandler)
